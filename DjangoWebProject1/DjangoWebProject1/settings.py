...
SECRET_KEY = '39ae5aac-82ea-4273-a1d1-4a43bf935480'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['broomthelast.pythonanywhere.com']
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Каталог, куда будут сохраняться загруженные файлы
